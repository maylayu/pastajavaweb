...
public class JurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Resultado de Calculo de Juros Compostos " + request.getContextPath() + "</h1>");
            try{
                ...
                double ju2 = ju/100;
                double resultado = val * Math.pow((1+ju2), temp);
                out.println("<hr/>");
                out.println("<table border='5'>");
                out.println("<tr><th>Valor:</th><th>"+val+"</th>"
                        + "<tr><th>Taxa: </th><th>"+ju+"</th><tr><th>Meses:</th><th>"+temp+"</th>"
                                + "<tr><th>Resultado:</th><th>"+resultado+"</th>");
